  ...
  return (
    <section className="landing-section">
      ...
      <div className="landing-shell">
        <div className="landing-stage justify-between py-8 pb-14 max-sm:justify-start max-sm:gap-6 max-sm:px-5 max-sm:py-8 max-sm:pb-14 [@media(max-height:840px)]:justify-start [@media(max-height:840px)]:gap-5 [@media(max-height:840px)]:py-4">
          <div className="mx-auto flex h-full w-full flex-col justify-between gap-7 max-sm:justify-start max-sm:gap-6 [@media(max-height:840px)]:justify-start [@media(max-height:840px)]:gap-4">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-3.5 max-sm:grid-cols-1 [@media(max-height:840px)]:gap-2.5">
              {pillars.map((pillar) => (
                <article
                  key={pillar.id}
                  className="landing-panel rounded-[22px] flex flex-row p-4 sm:p-4.5 md:p-5 [@media(max-height:840px)]:rounded-[18px] [@media(max-height:840px)]:p-3.5"
                >
                  <div className="flex w-[12rem] h-full items-center justify-center ">
                    <img
                  ...
                  <div className="mx-4 border-l border-white/8 [@media(max-height:840px)]:mx-3.5" />
                  <div className="mt-3.5 space-y-1.5 [@media(max-height:840px)]:mt-2.5 [@media(max-height:840px)]:space-y-1">
